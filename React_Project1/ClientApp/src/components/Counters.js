  ...
  render() {
    return (
      <div>
        ...
        <button className="btn btn-primary m-2" onClick={this.handleReset}>Reset Me</button>
        {/*  <Counter />*/}
        {/*  <Counter></Counter>*/}
        ...
        {/*the key={x.id} above is never treated as arg and all the others are arguments. value=.. otherw.. can be placed into one object like counter={x} */}
